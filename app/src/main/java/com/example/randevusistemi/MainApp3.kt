...
import com.example.randevusistemi.databinding.ActivityMainApp3Binding
...
class MainApp3 : AppCompatActivity() {
    private lateinit var binding: ActivityMainApp3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMainApp3Binding.inflate(layoutInflater)
        ...
        val buttonIds = listOf(R.id.masa19, R.id.masa20, R.id.masa21, R.id.masa22, R.id.masa23, R.id.masa24, R.id.masa25, R.id.masa26, R.id.masa27)
        ...
        runnable = object : Runnable {
            override fun run() {
                ...
                buttonIds.forEachIndexed { index, buttonId ->
                    ...
                    checkTableStatus("masa${index + 19}", button)
                }
