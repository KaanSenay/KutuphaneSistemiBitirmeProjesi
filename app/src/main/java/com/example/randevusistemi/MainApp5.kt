...
import com.example.randevusistemi.databinding.ActivityMainApp5Binding
...
class MainApp5 : AppCompatActivity() {
    private lateinit var binding: ActivityMainApp5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMainApp5Binding.inflate(layoutInflater)
        ...
        val buttonIds = listOf(R.id.masa37, R.id.masa38, R.id.masa39, R.id.masa40, R.id.masa41, R.id.masa42, R.id.masa43, R.id.masa44, R.id.masa45)
        ...
        runnable = object : Runnable {
            override fun run() {
                ...
                buttonIds.forEachIndexed { index, buttonId ->
                    ...
                    checkTableStatus("masa${index + 37}", button)
                }
