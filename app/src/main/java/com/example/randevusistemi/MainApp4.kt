...
import com.example.randevusistemi.databinding.ActivityMainApp4Binding
...
class MainApp4 : AppCompatActivity() {
    private lateinit var binding: ActivityMainApp4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMainApp4Binding.inflate(layoutInflater)
        ...
        val buttonIds = listOf(R.id.masa28, R.id.masa29, R.id.masa30, R.id.masa31, R.id.masa32, R.id.masa33, R.id.masa34, R.id.masa35, R.id.masa36)
        ...
        runnable = object : Runnable {
            override fun run() {
                ...
                buttonIds.forEachIndexed { index, buttonId ->
                    ...
                    checkTableStatus("masa${index + 28}", button)
                }
